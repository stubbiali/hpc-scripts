...
def core(
    ...
    with common.utils.batch_file(filename="prepare_" + project_with_underscores) as (f, fname):
        ...
        common.utils.export_variable(project_with_underscores.upper(), project_dir)
        venv_dir = os.path.join(project_dir, "_venv", env)
        common.utils.export_variable(project_with_underscores.upper() + "_VENV", venv_dir)
